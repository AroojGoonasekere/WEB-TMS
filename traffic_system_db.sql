...
-- Insert sample data that matches your screenshots
INSERT INTO `user_profiles` (`user_id`, `name`, `email`, `bio`) VALUES
(1, 'John Doe', 'john.doe@example.com', 'Web developer, coffee lover, and tech enthusiast.');